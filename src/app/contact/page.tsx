          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="bg-terracotta text-white px-8 py-3 text-sm font-medium tracking-wide hover:bg-terracotta-dark active:scale-[0.97] focus-visible:ring-2 focus-visible:ring-terracotta/40 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100"
              >
